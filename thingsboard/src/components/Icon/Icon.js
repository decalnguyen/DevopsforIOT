export const LinuxIcon = ({ width = '24px', height = '24px' }) => {
  return (
    <mat-icon
      _ngcontent-cmf-c843=""
      role="img"
      svgicon="linux"
      class="mat-icon notranslate tabs-icon mat-icon-no-color ng-star-inserted"
      aria-hidden="true"
      data-mat-icon-type="svg"
      data-mat-icon-name="linux"
    >
      <svg
        width={width}
        height={height}
...
export const MacIcon = ({ width = '24px', height = '24px' }) => {
  return (
    <svg
      width={width}
      height={height}
    ...
    >
      <path
        d="M21.873 16.68c-.517 1.15-.767 1.664-1.432 2.678-.932 1.418-2.247 3.188-3.87 3.199-1.446.013-1.82-.943-3.782-.926-1.961.009-2.37.945-3.818.93-1.625-.015-2.868-1.61-3.8-3.025-2.607-3.97-2.882-8.623-1.272-11.098 1.14-1.755 2.942-2.786 4.635-2.786 1.725 0 2.81.947 4.234.947 1.384 0 2.226-.95 4.22-.95 1.508 0 3.102.822 4.242 2.24-3.727 2.043-3.122 7.366.643 8.791Zm-6.4-12.615C16.2 3.134 16.752 1.82 16.55.48c-1.183.081-2.567.837-3.375 1.815-.733.893-1.34 2.217-1.104 3.497 1.292.042 2.628-.729 3.403-1.727Z"
        fill="currentColor"
      ></path>
    </svg>
  );
...
export const WindowsIcon = ({ width = '24px', height = '24px' }) => {
  return (
    <svg
      width={width}
      height={height}
    ...
    >
      <path
        d="M10.1 12.8H2.9V19l7.2.99V12.8Zm0-8.8L2.9 5v6.2h7.2V4Zm1.6-.2v7.4h10.4V2.4L11.7 3.8Zm0 9v7.4l10.4 1.4v-8.8H11.7Z"
        fill="currentColor"
      ></path>
    </svg>
  );
...
export const DockerIcon = ({ width = '24px', height = '24px' }) => {
  return (
    <mat-icon
      _ngcontent-cmf-c843=""
      role="img"
